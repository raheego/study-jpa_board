...
public class CommentService {
    ...
    public Long save(CommentDTO commentDTO) {
        ...
        if (optionalBoardEntity.isPresent()) { //부모엔티티 조회 게시글 여부
    ...
    public List<CommentDTO> findAll(Long boardId) {
        ...
        List<CommentEntity> commentEntityList = commentRepository.findAllByBoardEntityOrderByIdDesc(boardEntity); //부모엔티티값을 매개변수로 넣음
        /* EntityList -> DTOList */
